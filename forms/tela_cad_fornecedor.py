...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.widget_6.setMaximumSize(QtCore.QSize(16777215, 130))
        ...
        self.line_Registro.setMinimumSize(QtCore.QSize(0, 0))
        self.line_Registro.setMaximumSize(QtCore.QSize(16777215, 16777215))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.line_CNPJ = QtWidgets.QLineEdit(self.widget_9)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.horizontalLayout_5.addWidget(self.line_CNPJ)
        ...
        self.widget_13.setSizeIncrement(QtCore.QSize(0, 45))
        ...
        self.line_Consulta_Siger = QtWidgets.QLineEdit(self.widget_13)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.line_Consulta_Siger.sizePolicy().hasHeightForWidth())
        self.line_Consulta_Siger.setSizePolicy(sizePolicy)
        self.line_Consulta_Siger.setMinimumSize(QtCore.QSize(0, 25))
        self.line_Consulta_Siger.setMaximumSize(QtCore.QSize(16777215, 25))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.line_Consulta_Siger.setFont(font)
        self.line_Consulta_Siger.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.line_Consulta_Siger.setInputMask("")
        self.line_Consulta_Siger.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.line_Consulta_Siger.setObjectName("line_Consulta_Siger")
        self.horizontalLayout_8.addWidget(self.line_Consulta_Siger)
        self.btn_Consulta_Siger = QtWidgets.QPushButton(self.widget_13)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.btn_Consulta_Siger.sizePolicy().hasHeightForWidth())
        self.btn_Consulta_Siger.setSizePolicy(sizePolicy)
        self.btn_Consulta_Siger.setMinimumSize(QtCore.QSize(80, 0))
        self.btn_Consulta_Siger.setMaximumSize(QtCore.QSize(80, 16777215))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        self.btn_Consulta_Siger.setFont(font)
        self.btn_Consulta_Siger.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.btn_Consulta_Siger.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.btn_Consulta_Siger.setAutoFillBackground(False)
        self.btn_Consulta_Siger.setStyleSheet("background-color: rgb(141, 141, 141);")
        self.btn_Consulta_Siger.setCheckable(False)
        self.btn_Consulta_Siger.setAutoDefault(False)
        self.btn_Consulta_Siger.setDefault(False)
        self.btn_Consulta_Siger.setFlat(False)
        self.btn_Consulta_Siger.setObjectName("btn_Consulta_Siger")
        self.horizontalLayout_8.addWidget(self.btn_Consulta_Siger)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_25.setText(_translate("MainWindow", "Reg. Siger:"))
        ...
        self.label_7.setText(_translate("MainWindow", "Consulta Reg. Siger:"))
        self.btn_Consulta_Siger.setText(_translate("MainWindow", "Consultar"))
        ...
        item.setText(_translate("MainWindow", "Siger"))
