...
# Form implementation generated from reading ui file 'tela_cad_funcionario.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.line_CPF = QtWidgets.QLineEdit(self.widget_16)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.line_CPF.sizePolicy().hasHeightForWidth())
        self.line_CPF.setSizePolicy(sizePolicy)
        self.line_CPF.setMinimumSize(QtCore.QSize(0, 25))
        self.line_CPF.setMaximumSize(QtCore.QSize(16777215, 25))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.line_CPF.setFont(font)
        self.line_CPF.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.line_CPF.setText("")
        self.line_CPF.setMaxLength(45)
        self.line_CPF.setAlignment(QtCore.Qt.AlignCenter)
        self.line_CPF.setObjectName("line_CPF")
        self.horizontalLayout_11.addWidget(self.line_CPF)
        self.label_2 = QtWidgets.QLabel(self.widget_16)
        self.label_2.setText("")
        self.label_2.setObjectName("label_2")
        self.horizontalLayout_11.addWidget(self.label_2)
        self.check_Ativo = QtWidgets.QCheckBox(self.widget_16)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.check_Ativo.sizePolicy().hasHeightForWidth())
        self.check_Ativo.setSizePolicy(sizePolicy)
        self.check_Ativo.setMinimumSize(QtCore.QSize(80, 0))
        self.check_Ativo.setMaximumSize(QtCore.QSize(80, 16777215))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        self.check_Ativo.setFont(font)
        self.check_Ativo.setObjectName("check_Ativo")
        self.horizontalLayout_11.addWidget(self.check_Ativo)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "Dados Cadastro"))
        ...
        self.check_Ativo.setText(_translate("MainWindow", "ATIVO"))
