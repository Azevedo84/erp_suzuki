...
# Form implementation generated from reading ui file 'tela_prod_vendas.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.table_Vendas = QtWidgets.QTableWidget(self.widget_Cor2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.table_Vendas.sizePolicy().hasHeightForWidth())
        self.table_Vendas.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(8)
        self.table_Vendas.setFont(font)
        self.table_Vendas.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.table_Vendas.setObjectName("table_Vendas")
        self.table_Vendas.setColumnCount(11)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.table_Vendas.setHorizontalHeaderItem(7, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_Vendas.setHorizontalHeaderItem(8, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_Vendas.setHorizontalHeaderItem(9, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_Vendas.setHorizontalHeaderItem(10, item)
        self.verticalLayout_3.addWidget(self.table_Vendas)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Vendas do Produto"))
        self.label_13.setText(_translate("MainWindow", "Vendas de Produto"))
        ...
        item.setText(_translate("MainWindow", "DT ENTREGA"))
        item = self.table_Vendas.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Nº NF"))
        ...
        item.setText(_translate("MainWindow", "R$_UNID"))
        ...
        item = self.table_Vendas.horizontalHeaderItem(7)
        item.setText(_translate("MainWindow", "EMISSÃO OV"))
        item = self.table_Vendas.horizontalHeaderItem(8)
        item.setText(_translate("MainWindow", "CÓD. CLIENTE"))
        item = self.table_Vendas.horizontalHeaderItem(9)
        item.setText(_translate("MainWindow", "CLIENTE"))
        item = self.table_Vendas.horizontalHeaderItem(10)
